...
sprites.onOverlap(SpriteKind.EnemyProjectile, SpriteKind.Enemy, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
    sprite.destroy()
})
...
statusbars.onStatusReached(StatusBarKind.EnemyHealth, statusbars.StatusComparison.LTE, statusbars.ComparisonType.Fixed, 1500, function (status) {
    enemyDamage += enemyDamage * 2
    myEnemy.follow(mySprite, 80)
    mySprite.sayText("Monster is enraged! Be careful!", 3000, false)
...
game.onUpdateInterval(15000, function () {
    healthBoost = sprites.create(img`
        ...
        ....................
        `, SpriteKind.Food2)
    healthBoost.setPosition(randint(60, 100), randint(60, 100))
})
